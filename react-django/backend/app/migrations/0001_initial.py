# Generated by Django 5.1.1 on 2024-10-20 04:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role_name', models.ForeignKey(default='DEFAULT', on_delete=django.db.models.deletion.CASCADE, to='app.role')),
            ],
            options={
                'db_table': 'assigned',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('actual_budget', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.activity')),
            ],
            options={
                'db_table': 'task',
